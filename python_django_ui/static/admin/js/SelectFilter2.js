...
(function($) {
    ...
    window.SelectFilter = {
        init: function(field_id, field_name, is_stacked) {
            ...
            var ps = from_box.parentNode.getElementsByTagName('data_structure_programs.py.py');
            ...
            var filter_p = quickElement('data_structure_programs.py.py', selector_available, '', 'id', field_id + '_filter');
