...
def single_slug(request, single_slug):
    ...
    if single_slug in tutorials:
        ...
        return render(request, "main/tutorial.html",
                      {"tutorial": this_tutorial, "sidebar": tutorials_from_series, "this_tutorial_idx": this_tutorial_idx})
...
def register(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            for msg_key, msg_value in form.error_messages.items():
                messages.error(request, f"{msg_key}: {msg_value}")
