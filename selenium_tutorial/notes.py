...
# disabled tag = somevalue - disabled
...
action_chains.move_to_element(element).click().perform()  # click_and_hold, release
action_chains.drag_and_drop(element, element).perform()
action_chains.drag_and_drop_by_offset(element, 10, 0).perform()
