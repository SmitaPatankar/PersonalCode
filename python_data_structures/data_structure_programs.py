...
pop - topmost element - swap first and last element - delete last element - bubble first elemnt down to its correct position by comparing to its left child and swapping and so on
"""
...
insert as a leaf at the correct position from root, insert below it's less than the elemnt being compared, traverse to left sub tree, left subtree, right subtree
...
traversal:
    ...
    inorder - sorted - botom left most to top and right
