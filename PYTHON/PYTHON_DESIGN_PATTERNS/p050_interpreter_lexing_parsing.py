# process text
# eg: compilers, IDE, browser processing of html, numeric expression evaluation by computer, regex
# turn strings into oop objects

# lexing
# split text into token

# parsing
# interpret token into oop structure
